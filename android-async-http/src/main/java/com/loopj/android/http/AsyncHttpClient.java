...
public class AsyncHttpClient {
    ...
    private final Map<String, RequestHandle> requestHandleMap;
...
//        sslSocketFactory = MySSLSocketFactory.getFixedSocketFactory();
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        requestHandleMap = Collections.synchronizedMap(new WeakHashMap<String, RequestHandle>());
            ...
            public void process(HttpRequest request, HttpContext context) {
                ...
                for (String header : clientHeaderMap.keySet()) {
                    if (request.containsHeader(header)) {
                        ...
                        //cii_remove the overwritten header
    ...
    /**
     * Will, before sending, cii_remove all headers currently present in AsyncHttpClient instance, which
    ...
    public void cancelRequest(final Context context, final boolean mayInterruptIfRunning, final String packetId) {
        if (context == null) {
            return;
        }

        final RequestHandle requestHandle = requestHandleMap.get(packetId);

        if (Looper.myLooper() == Looper.getMainLooper()) {
            Runnable runnable = new Runnable() {
                @Override
                public void run() {
                    cancelRequest(requestHandle, mayInterruptIfRunning, packetId);
                }
            };
            threadPool.submit(runnable);
        } else {
    ...
    private void cancelRequest(final RequestHandle requestHandle, final boolean mayInterruptIfRunning, String packetId) {
        if (requestHandle != null) {
            requestHandle.cancel(mayInterruptIfRunning);
            requestHandleMap.remove(packetId);
        }
    }
    ...
    public RequestHandle head(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, new HttpHead(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, responseHandler, context, null);
    }
    ...
    public RequestHandle get(String url, RequestParams params, ResponseHandlerInterface responseHandler, String packetId) {
        return get(null, url, params, responseHandler, packetId);
    }
    ...
    public RequestHandle get(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, responseHandler, context, null);
    }

    public RequestHandle get(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler, String packetId) {
        return sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, responseHandler, context, packetId);
    }
    ...
    public RequestHandle get(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpGet(URI.create(url).normalize()), entity), contentType, responseHandler, context, null);
    }
    ...
    public RequestHandle post(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler, String packetId) {
        return post(context, url, paramsToEntity(params, responseHandler), null, responseHandler, packetId);
    }
    ...
    public RequestHandle post(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPost(getURI(url)), entity), contentType, responseHandler, context, null);
    }

    public RequestHandle post(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler, String packetId) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPost(getURI(url)), entity), contentType, responseHandler, context, packetId);
    }
    ...
    public RequestHandle post(Context context, String url, Header[] headers, HttpEntity entity, String contentType,
        ...
        if (headers != null) request.setHeaders(headers);
        return sendRequest(httpClient, httpContext, request, contentType, responseHandler, context, null);
    }
    ...
    public RequestHandle put(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPut(getURI(url)), entity), contentType, responseHandler, context, null);
    }
    ...
    public RequestHandle patch(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPatch(getURI(url)), entity), contentType, responseHandler, context, null);
    }
    ...
    public RequestHandle delete(Context context, String url, ResponseHandlerInterface responseHandler) {
        ...
        return sendRequest(httpClient, httpContext, delete, null, responseHandler, context, null);
    }
    ...
    public void delete(String url, RequestParams params, AsyncHttpResponseHandler responseHandler) {
        ...
        sendRequest(httpClient, httpContext, delete, null, responseHandler, null, null);
    }
    ...
    public RequestHandle delete(Context context, String url, Header[] headers, RequestParams params, ResponseHandlerInterface responseHandler) {
        ...
        return sendRequest(httpClient, httpContext, httpDelete, null, responseHandler, context, null);
    }
    ...
    public RequestHandle delete(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpDelete(URI.create(url).normalize()), entity), contentType, responseHandler, context, null);
    }
     ...
     * @return RequestHandle of future request process
     */
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context, String packetId) {
        if (uriRequest == null) {
        ...
        requestHandleMap.put(packetId, requestHandle);
