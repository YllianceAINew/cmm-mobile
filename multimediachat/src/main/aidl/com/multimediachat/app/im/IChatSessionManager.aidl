...
interface IChatSessionManager {
     ...
     * @param contactAddress the address of the contact.
     */
    IChatSession createMultiUserChatSession(String roomName, String roomAddress);
    IChatSession joinMultiUserChatSession(String roomName, String roomAddress); //cys
    ...
    /*show notification on app icon
     */ 
    void showNotifyCount();
}
