...
import com.multimediachat.app.im.IDataListener;
...
interface IChatSession {
     ...
     */
    void inviteContact(String reason,String contact);

    void sendInviteMsg(String text);
     ...
     */
    void sendMessage(String message, String offerId, String filePath);
    /**
     * Mark this chat session as read.
     */
    void sendMessageSeen(String packetId, String myPacketId);
    void sendMessagesSeen();
    void deleteMessage(String packetId, String myPacketId);
    void editMessage(String packetId, String myPacketId, String message);

    void insertCallMessageInDb(String message, int messageType, boolean isVideo, int callDuration);
}
