...
oneway interface IContactListListener {
     ...
     *  </ul>
     *
     * @see com.multimediachat.app.im.engine.ContactListListener#onContactChange(int, ContactList, Contact)
     */
     ...
     *
     * @see com.multimediachat.app.im.engine.ContactListListener#onAllContactListsLoaded()
     */
     ...
     *
     * @see com.multimediachat.app.im.engine.ContactListListener#onContactsPresenceUpdate(Contact[])
     */
     ...
     *
     * @see com.multimediachat.app.im.engine.ContactListListener#onContactError(int, ImErrorInfo, String, Contact)
     */
