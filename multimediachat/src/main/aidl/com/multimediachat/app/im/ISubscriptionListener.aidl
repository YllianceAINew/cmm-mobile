...
oneway interface ISubscriptionListener {
     ...
     *  </ul>
     *
     * @see com.multimediachat.app.im.engine.SubscriptionRequestListener#onSubScriptionRequest(Contact from)
     */
     ...
     *
     * @see com.multimediachat.app.im.engine.SubscriptionRequestListener#onSubscriptionApproved(String contact)
     */
     ...
     *
     * @see com.multimediachat.app.im.engine.ContactListListener#onSubscriptionDeclined(String contact)
     */
    void onSubscriptionDeclined(in Contact from, long providerId, long accountId);
    
    void onUnSubScriptionRequest(in Contact from, long providerId, long accountId);
    
    void onCanceledRequest(in Contact from, long providerId, long accountId);
}
