...
interface IChatListener {
     ...
     */
    boolean onIncomingMessage(IChatSession ses, in com.multimediachat.app.im.engine.Message msg);
     ...
     */
    void onSendMessageError(IChatSession ses, in com.multimediachat.app.im.engine.Message msg, in ImErrorInfo error);
     ...
     */
    void onIncomingOper(IChatSession ses, in String packetId, in String operType, in String operMessage, in String operMsgId);

	/** This method is called when OTR status changes */
	void onStatusChanged(IChatSession ses);
	
	/** This method is called when message is postponed */
	void onMessagePostPoned(IChatSession ses, in String packetId);
	
	void onMessageOperPostPoned(IChatSession ses, in String packetId);
	void onSentMessage(IChatSession ses, in String packetId);
}