...
interface IImConnection {
    ...
    IFindFriendManager  getFindFriendManager();  //cys
    ...
    void notifyContactsPresenceUpdated(in Contact contact);
    /**
    ...
    void loadVcard(String addr, String hash, boolean needName);
    boolean isPicaConnection();
}
