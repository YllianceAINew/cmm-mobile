...
public class ImServiceConstants {
    ...
    public static final ComponentName IM_SERVICE_COMPONENT = new ComponentName(
            "com.multimediachat",
            "com.multimediachat.service.MessengerService");
    
    public static final ComponentName FTP_SERVICE_COMPONENT = new ComponentName(
            "com.multimediachat",
            "com.multimediachat.service.FtpService");
    ...
    /**
     * Use EXTRA_INTENT_FROM_ADDRESS to include the from address of a contact in
     * an intent.
     */
    ...
    public static final String EXTRA_INTENT_SUB_TYPE = "subscriptionType";
    ...
    /**
     * use EXTRA_INTENT_NICKNAME to include the nickname in an intent.
     */
    public static final String EXTRA_INTENT_NICKNAME = "nickName";
    
    public static final String EXTRA_CHECK_AUTO_LOGIN = "autologin";

    /**
     * USE EXTRA_INTENT_SHOW_MULTIPLE to inform the activity to show multiple
     * chat notifications
     */
