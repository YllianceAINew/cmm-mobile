...
public class ContactListAdapter extends com.multimediachat.app.im.IContactList.Stub {
    ...
    public int addContact(String address) {
        if (address == null) {
            MessengerService.debug("Address can't be null!");
    ...
    public void setName(String name) {
        if (name == null) {
            MessengerService.debug("Name can't be null!");
            return;
        }
