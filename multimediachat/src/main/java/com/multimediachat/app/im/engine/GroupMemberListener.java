...
public interface GroupMemberListener {
     ...
     *
     * @param contact the contact who has been invited into this group.
     */
    void onMemberInvited(ChatGroup group, Contact contact);
    /**
    ...
    /**
     * Called when a previous request to add or cii_remove a member to/from a group
     * failed.
     * 
