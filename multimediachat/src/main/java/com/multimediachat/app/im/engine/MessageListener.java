...
public interface MessageListener {
    ...
    void onMessageOperPostponed(ChatSession ses, String id, String operType, String operMsgId, String operMessage);
     ...
     */
    void onIncomingOper(ChatSession ses, String id, String operType, String operMessage, String operMsgId);
     ...
     * @param ses the ChatSession.
     */
    void onReceiptsExpected(ChatSession ses);
    
    void onSentMessage(ChatSession ses, String packetId);
}
