...
public abstract class ChatGroupManager {
     ...
     * @throws Exception 
     */
    public abstract boolean createChatGroupAsync(String roomName, String roomAddress) throws Exception;
    ...
    /*
     * author:cys
     * description: addGroupMemberToBlock
     */
    
    protected abstract void setGroupMemberBlocked(ChatGroup group, String address, boolean isBlocked);
     ...
     * ChatGroup can cii_remove its members.
     * 
     ...
     */
    public abstract void joinChatGroupAsync(String roomName, Address address, String senderAddr, String lastPacketId);
     ...
     */
    public abstract int leaveChatGroupAsync(ChatGroup group);
     ...
     */
    public abstract void inviteUserAsync(String reason,ChatGroup group, Contact invitee);
    ...
    public abstract void leaveRoom(String chatRoomJid);
    ...
    public abstract void autoJoinMuc();
    ...
    /**
     * Put a ChatGroup into mGroups.
     * 
     * @param address the address of the ChatGroup.
     * @param chatGroup ChatGroup
     */
    public void addChatGroup(String address, ChatGroup chatGroup) {
     ...
     */
    protected void notifyMemberInvited(ChatGroup group, Contact contact) {
        group.notifyMemberInvited(contact);
    }
