...
public interface ContactListListener {
    ...
    int CONTACT_HIDDEN = 9; //cys
    int CONTACT_UNHIDDEN = 10; //cys
    int CONTACT_STATUS_UPDATED = 11; //cys
    int CONTACT_AVATAR_UPDATED = 12; //cys
    int CONTACT_ADDED_TEMPORARY = 13;
    int CONTACT_FAVORITE = 14;
    int CONTACT_UNFAVORITE = 15;
    int CONTACT_UPDATE = 16;
     ...
     *            the contact to cii_remove <li>{@link #ERROR_BLOCKING_CONTACT}
