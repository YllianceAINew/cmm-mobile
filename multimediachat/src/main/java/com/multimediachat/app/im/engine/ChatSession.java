...
public class ChatSession {
     ...
     */
    public String sendMessageAsync(Message message) {

    	if (message.getTo() == null)
    		message.setTo(mParticipant.getAddress());

    	mHistoryMessages.add(message);
    	return mManager.sendMessageAsync(this, message);
    }
...
//            
    ...
    public void onMessageOperReceipt(String id, String operType, String operMessage, String operMsgId) {
        for (MessageListener listener : mListeners) {
            listener.onIncomingOper(this, id, operType, operMessage, operMsgId);
        }
    }
    ...
    public void onMessageOperPostponed(String id, String operType, String operMsgId, String operMessage) {
    	for (MessageListener listener : mListeners) {
            listener.onMessageOperPostponed(this, id, operType, operMsgId, operMessage);
        }
    }
    ...
    public void onSendMessageError(String messageId, ImErrorInfo error) {
        ...
        DebugConfig.info("ChatSession", "Message has been removed when we get delivery error:" + error);
    }
