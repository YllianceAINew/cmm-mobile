package com.multimediachat.ui.views.gestures.transition.tracker;
 ...
 * be no changes to them which will change existing items' positions. So you can't cii_remove items, or
