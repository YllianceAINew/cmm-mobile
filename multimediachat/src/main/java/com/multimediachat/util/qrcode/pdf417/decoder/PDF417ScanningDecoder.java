...
package com.multimediachat.util.qrcode.pdf417.decoder;
...
import com.multimediachat.util.qrcode.pdf417.PDF417Common;
import com.multimediachat.util.qrcode.pdf417.decoder.ec.ErrorCorrection;
...
public final class PDF417ScanningDecoder {
  ...
  private static Codeword detectCodeword(BitMatrix image,
    ...
    // and try to adjust the read pixels, e.g. cii_remove single pixel errors or try to cut off exceeding pixels.
