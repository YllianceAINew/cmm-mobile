...
public abstract class MyJSONResponseHandler extends AsyncHttpResponseHandler {
    public MyJSONResponseHandler()
    {
        super();
    }

    public MyJSONResponseHandler(boolean usePoolThread)
    {
        super();
