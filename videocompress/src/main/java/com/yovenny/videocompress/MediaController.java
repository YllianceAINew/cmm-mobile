                    ...
                    if (videoIndex >= 0) {
                        ...
                        try {
                            ...
                            if (Build.VERSION.SDK_INT < 18) {
                                ...
                                //Log.i("*****", "codec = " + codecInfo.getName() + " manufacturer = " + manufacturer + "device = " + Build.MODEL);
                            } else {
                                colorFormat = MediaCodecInfo.CodecCapabilities.COLOR_FormatSurface;
                            }
                            //Log.i("*****", "colorFormat = " + colorFormat);
                                        ...
                                        if (decoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                                            ...
                                            if (startTime > 0 && videoTime == -1) {
                                                if (info.presentationTimeUs < startTime) {
                                                    doRender = false;
                                                    //Log.i("*****", "drop frame startTime = " + startTime + " present time = " + info.presentationTimeUs);
                                                } else {
                                                ...
                                                if (!errorWait) {
                                                    if (Build.VERSION.SDK_INT >= 18) {
                                                        ...
                                                        if (inputBufIndex >= 0) {
                                                            ...
                                                            //Log.i("*****", "input buffer not available");
                                                        }
                                                    }
                                                }
                                            }
